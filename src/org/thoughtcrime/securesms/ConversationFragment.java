  ...
  implements LoaderManager.LoaderCallbacks<Cursor>
{
  ...
  private void updateQuickReply() {
    if (getListAdapter().getSelectedItems().size() == 1) {
      MessageRecord selectedMesage = getSelectedMessageRecord();
      listener.setQuickReply(canReplyTo(selectedMesage) ? selectedMesage : null);
    } else {
